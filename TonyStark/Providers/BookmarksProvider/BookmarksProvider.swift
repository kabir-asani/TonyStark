...
protocol BookmarksProviderProtocol: Provider {
...
class BookmarksProvider: BookmarksProviderProtocol {
    static let shared: BookmarksProviderProtocol = BookmarksProvider()
