...
protocol SocialsProviderProtocol: Provider {
...
class SocialsProvider: SocialsProviderProtocol {
    static let shared: SocialsProviderProtocol = SocialsProvider()
