...
protocol ActionsTableViewCellInteractionsHandler: AnyObject {
    func onContinueWithGooglePressed()
    
    func onContinueWithApplePressed()
}

class ActionsTableViewCell: TXTableViewCell {
    // Declare
    override class var reuseIdentifier: String {
        String(describing: ActionsTableViewCell.self)
    }
    
    weak var interactionsHandler: ActionsTableViewCellInteractionsHandler?
    ...
    @objc private func onContinueWithGooglePressed(_ sender: TXButton) {
        interactionsHandler?.onContinueWithGooglePressed()
    }
    
    @objc private func onContinueWithApplePressed(_ sender: TXButton) {
        interactionsHandler?.onContinueWithApplePressed()
    }
}
