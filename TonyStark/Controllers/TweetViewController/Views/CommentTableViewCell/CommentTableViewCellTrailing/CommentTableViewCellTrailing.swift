...
class CommentTableViewCellTrailing: TXView {
    // Declare
    private let header: CommentTableViewCellTrailingHeader = {
        let header = CommentTableViewCellTrailingHeader()
    ...
    private let footer: CommentTableViewCellTrailingFooter = {
        let footer = CommentTableViewCellTrailingFooter()
