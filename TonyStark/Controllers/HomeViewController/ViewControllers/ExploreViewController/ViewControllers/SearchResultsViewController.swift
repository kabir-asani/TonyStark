...
class SearchResultsViewController: TXViewController {
    // Declare
...
extension SearchResultsViewController: TXTableViewDataSource {
...
extension SearchResultsViewController: TXTableViewDelegate {
    func tableView(
        _ tableView: UITableView,
        ...
        case .success(let paginated):
            ...
            openUserViewController(withUser: user)
...
extension SearchResultsViewController: PartialUserTableViewCellInteractionsHandler {
...
extension SearchResultsViewController {
    private func openUserViewController(withUser user: User) {
